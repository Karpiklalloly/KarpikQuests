...
[CreateProperty][JsonIgnore]        public Id Id
        {
            get => _id;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public Id ParentId
        {
            get => _parentId;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public string Name
        {
            get => _name;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public string Description
        {
            get => _description;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public Status Status
        {
            get => _status;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public ICompletionType CompletionType
        {
            get => _completionType;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public IProcessorType Processor
        {
            get => _processor;
        ...
        [DoNotSerializeThis][Property]
[CreateProperty][JsonIgnore]        public IEnumerable<Quest> SubQuests
        {
            get => _subQuests;
        ...
        [SerializeThis("Id")]
[SerializeField][JsonProperty(PropertyName = "Id")]        private Id _id;
        private Id _parentId = Id.Empty;
        private Quest? _parentQuest = null;
        private IGraph _graph;
        [SerializeThis("Name")]
[SerializeField][JsonProperty(PropertyName = "Name")]        private string _name;
        [SerializeThis("Description")]
[SerializeField][JsonProperty(PropertyName = "Description")]        private string _description;
        [SerializeThis("Status")]
[SerializeField][JsonProperty(PropertyName = "Status")]        private Status _status;
        [SerializeThis("CompletionType")]
[SerializeField][JsonProperty(PropertyName = "CompletionType")]        private ICompletionType _completionType;
        [SerializeThis("Processor")]
[SerializeField][JsonProperty(PropertyName = "Processor")]        private IProcessorType _processor;
        [SerializeThis("SubQuests")]
[SerializeField][JsonProperty(PropertyName = "SubQuests")]        private QuestCollection _subQuests = new();
